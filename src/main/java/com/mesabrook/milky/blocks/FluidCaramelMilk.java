...
public class FluidCaramelMilk extends Fluid
{
    ...
    public FluidCaramelMilk(String fluidName, int color) 
    {
        this(fluidName, color, milk_still, milk_flowing);
    }

    public FluidCaramelMilk(String fluidName, int color, ResourceLocation still, ResourceLocation flowing) 
    {
