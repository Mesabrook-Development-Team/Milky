...
public class FluidStrawberryMilk extends Fluid
{
    ...
    public FluidStrawberryMilk(String fluidName, int color) 
    {
        this(fluidName, color, milk_still, milk_flowing);
    }

    public FluidStrawberryMilk(String fluidName, int color, ResourceLocation still, ResourceLocation flowing) 
    {
