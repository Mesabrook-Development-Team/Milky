...
public class FluidChocolateMilk extends Fluid
{
    ...
    public FluidChocolateMilk(String fluidName, int color) 
    {
        this(fluidName, color, milk_still, milk_flowing);
    }

    public FluidChocolateMilk(String fluidName, int color, ResourceLocation still, ResourceLocation flowing) 
    {
